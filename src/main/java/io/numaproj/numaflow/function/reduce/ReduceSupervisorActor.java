...
public class ReduceSupervisorActor extends AbstractActor {
    ...
    public static Props props(
            ...
            Metadata md,
            StreamObserver<Udfunction.DatumList> responseObserver) {
        return Props.create(ReduceSupervisorActor.class, groupBy, md, responseObserver);
    }

    /*
        if there is an uncaught exception in supervisor actor terminate the system
     */
    @Override
    ...
    private final class ReduceSupervisorStratergy extends SupervisorStrategy {
        ...
        public void processFailure(
            ...
            System.out.println("got an error to process inside supervisor");
            throw new RuntimeException(cause);
//            shutdownActor.tell(cause, ActorRef.noSender());
        }
    }
}
